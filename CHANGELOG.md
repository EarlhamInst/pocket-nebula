...
## [1.5.0](https://github.com/EarlhamInst/pocket-nebula/compare/v1.4.1...v1.5.0) (2026-08-16)


### Features

* add shared devcontainer layer consumable by other repos ([1556b73](https://github.com/EarlhamInst/pocket-nebula/commit/1556b73b50465cd7a5066773734677c09437f492))
...
* share AGENTS.md core, git hooks and workaround tracking ([e12cd1c](https://github.com/EarlhamInst/pocket-nebula/commit/e12cd1cbb9d11875949979c2690e4cc328587704))
* share the devcontainer Cursor rule alongside AGENTS.md ([0d9304f](https://github.com/EarlhamInst/pocket-nebula/commit/0d9304f6d065d13c93fc8ccea9c0395d593f7fe7))


### Bug Fixes

* **ci:** find the release PR via the list endpoint, not search ([aa10d50](https://github.com/EarlhamInst/pocket-nebula/commit/aa10d50a357ec1b834a768a78569e2b0f25d4064))
* **ci:** match parked workflow runs by conclusion, not status ([a872f25](https://github.com/EarlhamInst/pocket-nebula/commit/a872f251c33ff449c5ef28c05bfcc652ab2c4253))
* **ci:** parse devcontainer.json as JSONC, not strict JSON ([e6863ac](https://github.com/EarlhamInst/pocket-nebula/commit/e6863accc0d6fbfd50a2fae16128fb2a5390f636))
* **ci:** pass --repo to gh in the release job ([dd95ebe](https://github.com/EarlhamInst/pocket-nebula/commit/dd95ebed59c65baff2d82e06f5c065a83e6cd6a8))
* **ci:** publish the base image on release via a reusable workflow ([57f44dc](https://github.com/EarlhamInst/pocket-nebula/commit/57f44dcd1ce91b33227b037bf020330222121865))
...
* **githooks:** annotate vault-guard for shellcheck ([95b9dfb](https://github.com/EarlhamInst/pocket-nebula/commit/95b9dfbb5bbe4137c3a50644e9395cd915d5bf2c))
* **githooks:** stop the vault guard flagging its own source ([30c7f32](https://github.com/EarlhamInst/pocket-nebula/commit/30c7f329e393d3031d22a1cd7c86e4a95dd486f2))
* **image:** restore remoteUser, which the metadata LABEL had silently dropped ([76e0125](https://github.com/EarlhamInst/pocket-nebula/commit/76e0125a5509aeccb4907730fd3fd6d3f8c32805))
...
* collapse shared-layer machinery into .devcontainer-shared/ ([4834bc2](https://github.com/EarlhamInst/pocket-nebula/commit/4834bc21d5802b8ca8f43065a553f63b8b4091a9))
